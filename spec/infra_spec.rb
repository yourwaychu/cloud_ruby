...
module CloudStack_Testing
  describe CloudStack, "Infra" do
    ...
    it "create infrastructure" do
      ...
      _zones.each do |zone|
        zone_obj = @cs.create_zone :name                => "#{zone['name']}",
                                   ...
                                   :localstorageenabled => "#{zone['localstorage']}"
    ...
    it "destroy infrastructure" do
      @cs.zones.each do |k, zone|
        zone.secondary_storages.values[0].delete
        zone.pods.values[0].clusters.values[0].storage_pools.values[0].delete
        zone.pods.values[0].clusters.values[0].hosts.values[0].delete
        zone.pods.values[0].clusters.values[0].delete
        zone.pods.values[0].delete
        zone.networks.values[0].delete
        zone.physical_networks.values[0].delete
        zone.delete
      end
